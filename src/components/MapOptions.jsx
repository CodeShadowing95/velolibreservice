...
const MapOptions = ({ zoom, onZoom, onResetZoom }) => {
  ...
  return (
    <div className="absolute top-4 right-4 flex flex-col gap-2 z-10">
      ...
      {/* Theme */}
      <div className="w-8 h-8 flex justify-center items-center bg-white p-2 rounded-lg shadow-xl cursor-pointer">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full object-contain" viewBox="0 0 24 24"><path fill="#000000" d="m12 18.54l7.37-5.74L21 14.07l-9 7l-9-7l1.62-1.26zM12 16L3 9l9-7l9 7zm0-11.47L6.26 9L12 13.47L17.74 9z"/></svg>
      </div>
