...
const Modal = () => {
  ...
  return (
    ...
    <div id="modal" className="absolute top-0 left-0 flex justify-center items-center w-full h-screen -translate-y-full bg-black/80 z-20 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10">
      ...
      {/* Message */}
      <div className="absolute top-44 left-12 rounded-xl w-[200px] flex justify-center items-center bg-zinc-900 p-4 text-white gap-4 border">
        ...
        <p className="text-xs font-light">Hop hop! Pas si vite, j'ai senti votre envie de dévorer ma Map, mais avant ça...</p>
      </div>
